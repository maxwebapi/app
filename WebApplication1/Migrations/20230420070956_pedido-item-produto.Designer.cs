...
namespace MaxWebApi.Migrations
{
    ...
    [Migration("20230420070956_pedido-item-produto")]
    partial class pedidoitemproduto
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MaxWebApi.Models.PedidoItem.PedidoItemModel", b =>
                {
                    ...
                    b.HasOne("MaxWebApi.Models.Produto.ProdutoModel", "Produto")
                        .WithMany()
